...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/Schadenaufnahme/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/Schadenaufnahme">Camunda BPM Process Application</a></td>
